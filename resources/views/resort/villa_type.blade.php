                ...
                <div class="col-md-4 col-sm-6">
                    <div class="explor_item">
                        <a href="{{ route('page.resort.villa_detail', $villa['id']) }}" class="room_image">
                            <img src="{{ $villa['images'][0] == '' ? 'img/room/room-1.jpg' : $villa['images'][0] }}"
                                alt="">
                        </a>
                        <div class="explor_text">
                            <a href="{{ route('page.resort.villa_detail', $villa['id']) }}">
                                <h4> {!! $villa['villa_name'] !!} </h4>
                            </a>
                            ...
                            <div class="explor_footer villa-footer">
                                ...
                                <div class="pull-left">
                                    ...
                                    <h3>{{ number_format($villa['foreigner_price']) }} {{ $villa['foreigne_currency'] }}
                                        <span>/
                                            Night </span>
                                    </h3>
                                ...
                                <div class="pull-right mt-4">
                                    <a class="book_now_btn"
                                        href="{{ route('page.resort.villa_detail', $villa['id']) }}">View details</a>
                                </div>
                            </div>
