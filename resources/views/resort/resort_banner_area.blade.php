<section class="" style="display:block; background-color:#1D3B28">
    <div class="container">
        <div class="banner_inner_content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-2 col-md-5 col-sm-5 col-xs-7" style="">
                        <img width="100%" src="{{ asset('images/logos/mangroveview_resort_circle_logo.jpg') }}" />
                    </div>
