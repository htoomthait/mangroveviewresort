            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="@if(session('page_title') === 'home') active @endif"><a href="{{route('home.page')}}" >Home</a></li>
                        <li class="@if(session('page_title') === 'about_us') active @endif"><a href="{{route('page.about_us')}}">About Us</a></li>
                        ...
                        <li class="submenu dropdown @if(session('page_title') === 'resort') active @endif">
                            <a href="{{route('page.activities')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Activities <i class="fa fa-chevron-down" aria-hidden="true"></i></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="submenu dropdown @if(session('page_title') === 'barAndRestaurant') active @endif">
                            <a href="{{route('page.bar_and_restaurant')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Bar &amp; Restaurant <i class="fa fa-chevron-down" aria-hidden="true"></i></a>
                            <ul class="dropdown-menu">
