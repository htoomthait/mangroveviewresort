<!--================Introduction Area =================-->
<section class="introduction_area intro_area2 bg_theme_green ">
    <div class="container">
        <div class="row introduction_inner">
            <div class="col-12 col-md-7">
                <div class="introduction_img">
                    {{-- <img src="images/room/img_1.jpg" alt=""> --}}
                    <a href="images/maps/garden_guide_map.jpg" data-lightbox="garden_guide_map_landing_page"
                        data-title="Garden Guide Map">
                        <i class="fa fa-expand"
                            style="position: absolute; z-index:100; margin-top:8px; left: 96%; font-size:21px;"
                            aria-hidden="true"></i>
                        <img src="images/maps/thumbnail/garden_guide_map_thumbnail.jpg" alt="guide map">
                    </a>
                    ...
                    {{-- <iframe
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d17125.190894150917!2d94.455162!3d17.051721!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3405ce2513bcd292!2sSea%20%26%20Lake%20Garden!5e1!3m2!1sen!2sbd!4v1657236479173!5m2!1sen!2sbd"
                            width="550"
                            height="450"
                            style="border:0;"
                            allowfullscreen=""
                            loading="lazy"
                            class="landing-page-google-map-iframe"
                ...
                <div class="introduction_left_text">
                    <div class="intro_title">
                        ...
                        <p>
                            ...
                            bicycles and electric buggies to enjoy the many charms of the gardens. Undertake an array of
                            activities suitable for different ages. It is a place where you can reconnect with nature
                            and revel in all the beauty it has to offer.
                        </p>
                    </div>
